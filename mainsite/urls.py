...
from . import views
from .views import IndexView, AboutView, AlefBaisBotsView, ChanukahBotsView, NekudosBotsView, PrivacyPolicyView, ContactView, SendEmailSuccessView, FantasyFootballersView, MitzvahBotTownView, SupportView
